...
public class ConnectFourApp extends ApplicationAdapter {
	...
	public void create () {
        ...
        camera.position.set(camera.viewportWidth / 2f - PADDING, camera.viewportHeight / 2f - PADDING, 0);
        camera.update();
	...
	public void render () {
        ...
        for (int y = 0; y < NUM_OF_ROWS; y++) {
            for (int x = 0; x < NUM_OF_COLUMNS; x++) {
                batch.draw(emptySlotTxRegion, x, y, 1, 1);
            }
        }
